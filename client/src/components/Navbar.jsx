  ...
  return (
    <div className="w-full h-15 py-4 me-8 flex justify-between border-b dark:border-b-gray-700">
      ...
      <div className="flex justify-between items-center gap-8">
        <button
          className="font-semibold border-spacing-1 p-1 rounded-md bg-black text-gray-400"
        >
        ...
        <Link
          to="/UserProfile"
          className="inline-block rounded-full bg-black w-9 h-9 mr-2 cursor-pointer"
        ></Link>
      </div>
